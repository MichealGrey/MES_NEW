...
| 工号 | 密码 | 角色 | 权限 |
|------|------|------|------|
| USR-ADMIN | SuperAdmin@2026 | 超级管理员 | 全部权限 |
| 10001 | admin123 | 系统管理员 | 全部权限 |
| 10002 | eng123 | 工程师 | 生产操作、工艺管理 |
| 10003 | op123 | 操作员 | 进站/出站操作 |
| 10004 | qa123 | 质量工程师 | 质量检验、Hold/Release |

> **注意**: 系统已统一使用 BCrypt 密码哈希算法，所有密码均经过安全加密存储。
